  ...
  return (
    ...
    <div className="p-2 h-full flex flex-col items-center justify-between" >
        ...
        <div className="w-full h-auto leading-tight pl-2 lg:pl-4">
            ...
            <h3 className="text-[14px] font-normal  mt-[5px]">{ad ? ad.title : null }</h3>
            <h2 className="text-[12px] font-light text-gray-500 mt-[2px]">{ad ? ad.description.length > 10 ? ad.description.slice(0,15)+"..." : ad.description : null}</h2>
