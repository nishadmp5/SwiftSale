  ...
  return (
    ...
    <div className="p-2 h-full flex flex-col items-center justify-between" >
        ...
        <div className="w-full h-auto leading-tight pl-2 lg:pl-4">
            <h1 className="text-[20px] font-semibold">{ad ? ad.price : "67000"}</h1>
            <h2 className="text-[14px] font-normal mt-[2px]">{ad ? ad.description : "none"}</h2>
            <h3 className="text-[12px] font-light text-gray-500 mt-[5px]">{ad ? ad.title : "swift"}</h3>
            <h3 className="text-[10px] font-light text-gray-500 mt-[5px]">{ad ? ad.location : "pattambi"}</h3>
        </div>
    </div>
</li>
  )
