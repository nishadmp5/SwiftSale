...
const Attributes = () => {
  ...
  return (
    <div className="w-full h-auto bg-white text-sblue m-0 p-0">
      <div className="min-h-screen w-full">
        <div className="w-full fixed flex items-center justify-center bg-slight py-5 px-4">
        ...
        {uploading ? (
          <div className="h-auto w-[40%] lg:w-[30%] mx-auto  pt-20">
            <img src={assets.uploading} alt="" />
          </div>
        ) : (
          <div className="h-auto w-full lg:w-[60%] mx-auto lg:px-32 lg:border lg:border-slate-300 pt-16">
              ...
              >
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <input
                    ...
                    value={title}
                    className="rounded-md px-3 py-2 border border-sblue border-solid"
                    id="title"
                    type="text"
                  />
                </div>
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <div className="rounded-md  border border-sblue flex items-center  border-solid">
                    <div className="pl-2 py-2 h-full flex gap-1 items-center justify-between">
                      <div className="text-sblue text-md">+91</div>
                    </div>
                    <input
                      required
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <div className="rounded-md  border border-sblue flex gap-1 items-stretch border-solid">
                    <div className="pl-2 py-2 h-full flex gap-1 items-center justify-between">
                      <div className="text-sblue text-xs ">
                        <LiaRupeeSignSolid />
                      </div>
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <div className="flex gap-2">
                    <label
                      className="border-2 text-sblue border-sblue border-solid flex flex-col items-center justify-center "
                      htmlFor="image1"
                    >
                      {image1 ? (
                        <img
                        ...
                        <div className="mx-4 my-5 flex justify-center items-center flex-col">
                          {" "}
                ...
                <div className="flex justify-center items-center w-full py-3">
                  <button
                    type="submit"
                    className="bg-slate-300 font-semibold px-24 py-3 rounded-md w-full"
                  >
                    Post now
                  </button>
                </div>
